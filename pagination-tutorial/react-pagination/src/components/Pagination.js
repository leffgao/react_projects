...
class Pagination extends Component {
  ...
  // lets say we have 10 pages and we set pageNeighbors to 2
  // given that the current page is 6
  // the pagination control will look like the following:
  // (1) < {4 5} [6] {7 8} > (10)
  // (x) terminal pages: first and last page(always visible)
  // {...x} => repressents page neighbors
  ...
  fetchPageNumbers = () => {
    ...
    // total blocks: totalNumbers + 2 to cover for the left and the right controls
    ...
    if (totalPages > totalBlocks) {
      ...
      // hasleftspill: has hiddewn pages to the left
      // has right spill: has hidden pages to the right
